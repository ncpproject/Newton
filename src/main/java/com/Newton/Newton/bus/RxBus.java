package com.Newton.Newton.bus;

import com.Newton.Newton.config.ConfigService;
import com.Newton.Newton.gui.FXMLView;
import com.Newton.Newton.gui.accountCreator.AccountCreator;
...
public class RxBus {
    ...
    private final BehaviorSubject<Long> assetbalanceBehaviorSubject = createBehaviorSubject();
    ...
    public BehaviorSubject<Long> getAssetBalance() {
        return assetbalanceBehaviorSubject;
    }
    ...
    public BehaviorSubject<HashMap<String, AssetDetails>> getAssetDetailsHashMap() { return assetDetailsHashMapBehaviorSubject; }
    ...
    public BehaviorSubject<NodeService> getNodeService() { return nodeService2BehaviorSubject; }
}
