package com.Newton.Newton.gui.dashboard;
...
import com.Newton.Newton.logic.NCP;
...
import static com.Newton.Newton.logic.FormValidator.ALIAS_PATTERN;
import static com.Newton.Newton.logic.FormValidator.isWellFormed;
...
public class DashboardController extends MasterController {
    ...
    @FXML private Label ncpBalanceLabel;
	...
	public void initialize() {
        ...
        emitter.observeOn(Schedulers.io())
                ...
                .map(getNodeService()::fetchNCPBalance)
                .retry()
                .filter(Optional::isPresent).map(Optional::get)
                .doOnNext(rxBus.getAssetBalance()::onNext)
                .observeOn(JavaFxScheduler.platform())
                .subscribe(this::setNCPBalanceLabel, Throwable::printStackTrace);
        ...
        /*Observable.merge(emitter, rxBus.getPrivateKeyAccount())
                ...
                .doOnNext(rxBus.getAssetBalance()::onNext)
                .observeOn(JavaFxScheduler.platform())
                .subscribe(this::setINCPBalanceLabel, Throwable::printStackTrace);*/
    ...
    private void setNCPBalanceLabel(Long aLong) {
        ncpBalanceLabel.setText(toReadable(aLong, NCP.DECIMALS));
    }
