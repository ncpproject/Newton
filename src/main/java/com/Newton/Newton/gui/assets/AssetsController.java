package com.Newton.Newton.gui.assets;

import com.Newton.Newton.bus.RxBus;
import com.Newton.Newton.gui.MasterController;
import com.Newton.Newton.logic.Asset;
import com.Newton.Newton.logic.Transferable;
...
public class AssetsController extends MasterController {
   ...
   /* private void initializeTableView() {
    ...
    /*private Waves NCPBalance() {
        final var node = getNode();
        final var privateKeyAccount = getPrivateKeyAccount();
        try {
            return new Waves(node.getBalance(privateKeyAccount.getAddress(), NCP.ASSET_ID));
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }*/
